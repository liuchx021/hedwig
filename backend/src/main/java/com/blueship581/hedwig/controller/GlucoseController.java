...
public class GlucoseController {
    ...
    /**
     * Get all stored readings for a subject.
     * GET /api/glucose/subjects/{subjectId}/readings
     */
    ...
    /**
     * Get the latest stored reading for a subject.
     * GET /api/glucose/subjects/{subjectId}/readings/latest
     */
    ...
    /**
     * Trigger a live fetch of the latest reading from the vendor.
     * POST /api/glucose/connections/{connectionId}/subjects/{subjectId}/fetch/latest
     */
    ...
    /**
     * Trigger a live fetch of historical readings from the vendor (last 24h).
     * POST /api/glucose/connections/{connectionId}/subjects/{subjectId}/fetch/history
     */
    ...
    /**
     * Sync recent glucose readings from the vendor, overwriting existing data
     * within the returned time range.
     * POST /api/glucose/subjects/{subjectId}/sync
     */
