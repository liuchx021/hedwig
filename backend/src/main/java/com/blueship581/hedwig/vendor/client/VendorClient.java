...
/**
 * Abstraction over different CGM vendor APIs.
 * Implementations: OttaiClient, SiSensingClient.
 */
public interface VendorClient {
    ...
    /**
     * Perform a login using vendor credentials and return a VendorTokenInfo with the new token.
     * Not all vendors support programmatic login (e.g. Ottai requires WeChat mini-program flow).
     */
     ...
     */
    VendorGlucoseData getLatestGlucose(String accessToken, String vendorUserId, VendorSubject subject);

    /**
     * Return historical glucose readings for the given subject.
     */
    List<VendorGlucoseData> getHistoricalGlucose(String accessToken, String vendorUserId, VendorSubject subject);
}
